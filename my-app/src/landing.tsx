      ...
      <main id="mainsection">
        ...
        <section id="accommodations">
          ...
          <div>
            ...
            <p style={{paddingRight: '10%', paddingLeft: '10%', fontSize: '1.1rem', textAlign: 'center'}}>{language === 'english' ? 'Shuttle Pickup times (afternoon) : TBA' : 'Heures de ramassage de l’autobus (après-midi) : '}</p>
            <p style={{paddingRight: '10%', paddingLeft: '10%', fontSize: '1.1rem', textAlign: 'center'}}>{language === 'english' ? 'Shuttle Drop-off times (night) : TBA' : 'Heures de dépôt de l’autobus (nuit) :'}</p>
            <div>
